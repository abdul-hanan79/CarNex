...
//                                 onChange={(item) => handleChange('country')(item.value)} // Pass the selected value directly to handleChange
...
//                                 value={values.state}
//                                 onChange={(item) => handleChange('state')(item.value)} // Pass the selected value directly to handleChange
...
//                                 value={values.city}
//                                 onChange={(item) => handleChange('city')(item.value)} // Pass the selected value directly to handleChange
...
//         //         console.log(error);
//         //     });
//         console.log("handlgeState is working", countryCode)
//     };
...
//         //         console.log(error);
//         //     });
//         console.log("handle city is working")
//     };
